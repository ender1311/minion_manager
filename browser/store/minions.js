...
export const createMinionThunk = minion => dispatch => {
  axios.post('http://18.222.117.114:8080/api/minions', minion)
  .then(res => res.data)
  .then(createdMinion => {
...
export const updateMinionThunk = minion => dispatch => {
  axios.put(`http://18.222.117.114:8080/api/minions/${minion.id}`, minion)
  .then(res => res.data)
  .then(updatedMinion => {
...
export const deleteMinionThunk = minionId => dispatch => {
  axios.delete(`http://18.222.117.114:8080/api/minions/${minionId}`)
  .then(res => res.data)
  .then(() => {
    return axios.get(`http://18.222.117.114:8080/api/minions`)
  })
  .then(res => res.data)
  .then(allMinions => {
